...
{cat("reading...")
  counts <- loadFiles("counts-lsec")
  cellanno <- loadFiles("cellanno-lsec")
...
conditions <- c("LSEC|DoubleKO", "LSEC|Wildtype")
...
ggsave(filename = figpattern("compare-lsec-marker-vs-eta.png"),
...
ggsave(filename = figpattern("compare-lsec-marker-vs-eta-rank.png"),
  plot = q, width = 16, height = 12, dpi = 200)
...
ggsave(filename = figpattern("compare-lsec-marker-vs-eta-rank-fixed.png"),
  plot = q, width = 16, height = 12, dpi = 200)
